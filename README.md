# go-electrum [![GoDoc](https://godoc.org/github.com/zauberhaus/go-electrum?status.svg)](https://godoc.org/github.com/zauberhaus/go-electrum)
...
## Usage
See [example/](https://github.com/zauberhaus/go-electrum/tree/master/example) for more.

### electrum [![GoDoc](https://godoc.org/github.com/zauberhaus/go-electrum/electrum?status.svg)](https://godoc.org/github.com/zauberhaus/go-electrum/electrum)
```bash
$ go get github.com/zauberhaus/go-electrum
```
